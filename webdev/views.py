...
@login_required(login_url='/github/authorize')
def day5(request):
    return render(request, "webdev/day5.html")

@login_required(login_url='/github/authorize')
def day6(request):
    return render(request, "webdev/day6.html")

@login_required(login_url='/github/authorize')
def day7(request):
    return render(request, "webdev/day7.html")

@login_required(login_url='/github/authorize')
def day8(request):
    return render(request, "webdev/day8.html")
